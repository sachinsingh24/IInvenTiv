...
const Home = () => {
  ...
  const images = [
    require('../../images/social/1.jpg'),
    require('../../images/social/2.jpg'),
    require('../../images/social/3.jpg'),
    require('../../images/social/4.jpg'),
    require('../../images/social/5.jpg'),
    require('../../images/social/6.jpg'),
    require('../../images/social/7.jpg'),
    require('../../images/social/8.jpg'),
    require('../../images/social/9.jpg'),
    require('../../images/social/10.jpg'),
    require('../../images/social/11.jpg'),
    require('../../images/social/12.jpg'),
  ];
  return (
    <section>
