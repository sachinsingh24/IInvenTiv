  ...
  return (
    <section className='logistic-section'>
      <div className='how-to-reach'>
        ...
        <h3>From Mahatma Gandhi Bus Station (54km)</h3>
        <ul>
        ...
        <h3>From Secunderabad Railway Station (50km)</h3>
        <ul>
        ...
        <p>Transportation will be provided for all the participants on January 19, 2024 from Airport/Railway Stations/Miyapur Metro Station</p>
        <h3>Nearby Hotels</h3>
        <h3>Stall Details</h3>
      </div>
    </section>
