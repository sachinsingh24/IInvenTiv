      ...
      <div className='how-to-reach container'>
        ...
        <div className='reach'>
          ...
          <ul>
            ...
            <li>
              Drive to Mumbai Hwy/NH 9 for 15 km, you will find the sign board
              of IITH on Right side
            </li>
          </ul>
          <h4>From Mahatma Gandhi Bus Station (54km)</h4>
          <ul>
            ...
            <li>Take exit towards Mumbai/NH65Take exit towards Mumbai/NH65</li>
            <li>
              Drive to Mumbai Hwy/NH 65 for 15 km, you will find the sign board
              of IITH on Right side
            </li>
          </ul>
          <h4>From Secunderabad Railway Station (50km)</h4>
          <ul>
            ...
            <li>
              Continue to drive on Mumbai Hwy/NH 65, you will find the sign
              board of IITH on Right side
            </li>
          </ul>
          <h4>From Hitech City (38km)</h4>
          <ul>
            <li>
          ...
          <ul>
            <li>
              Reach the Secunderabad-East Metro station which is about 600 mtrs
              from the Secunderabad Railway station.
            </li>
            <li>
              Take a ticket to Miyapur Station. You need to change metros to
              reach Miyapur Station.
            </li>
            ...
            <li>
              Take a bus to Sangareddy Town and you will find the sign board of
              IITH on Right side.
            </li>
          </ul>
          <h4>MMTS Route</h4>
          <ul>
            <li>
              Take an MMTS from Secunderabad Railway Station to Lingampally
              Railway Station.
            </li>
            <li>
              Take a bus from Lingampally Railway Station to Lingampally Bus
              stand.
            </li>
          ...
          <ul>
            <li>
              Transportation will be provided for all the participants on
              January 19, 2024 from Airport/Railway Stations/Miyapur Metro
              Station
            </li>
          </ul>
        </div>
