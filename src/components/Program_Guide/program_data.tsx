export const affordable_healthcare = [
    {   
        id: 1,
        title: 'Moderator',
...
export const agriculture_food_processing = [
    ...
    {   
        ...
        affiliations: 'Director, IIT Ropar',
        image: require('../../images/program_guidance/panel_member_pics/Panel Member Pics/9_rajeev_ahuja.jpg'),
    },
];
